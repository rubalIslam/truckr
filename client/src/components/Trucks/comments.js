...
class Comments extends Component {
  ...
  showCommentItems = () =>
    this.props.trucks.truckDetail.comments
      ? this.props.trucks.truckDetail.comments.map((item, i) => (
  ...
  submitForm = (event) => {
    ...
    let existingComments = this.props.trucks.truckDetail;
    let truckId = this.props.trucks.truckDetail._id;
    ...
    if (formIsValid) {
      this.props
        .dispatch(addTruckComments(truckId, commentsData))
        .then((response) => {
  ...
  componentDidMount() {
    this.props.dispatch(getTruckComments());
    //console.log(com);
    this.setState({
