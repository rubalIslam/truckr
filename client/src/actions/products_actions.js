...
export function addComments(_id,commentsData){

    const request = axios.post( `${PRODUCT_SERVER}/addComments?productId=${_id}`,commentsData)
    .then(response => {
...
export function getComments(){
    const request = axios.get(`${PRODUCT_SERVER}/getComments`)
                .then(response => response.data );
